...
class UserPermissionEvaluatorTest {
    ...
    @BeforeEach
    void setUp() {
        userPermissionEvaluator = new UserPermissionEvaluator(userService, teacherService);
        userPermissionEvaluator = Mockito.spy(userPermissionEvaluator);
    }
    ...
    void canView_notAdmin_userNotMatch() {
        ...
        Boolean actualAnswer = userPermissionEvaluator.canView(requestedUserId, userDetails);
